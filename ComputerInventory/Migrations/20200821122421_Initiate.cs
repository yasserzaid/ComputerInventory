        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportNumber = table.Column<string>(maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MachineID = table.Column<int>(nullable: false, comment: "Machine ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 25, nullable: false),
                    GeneralRole = table.Column<string>(maxLength: 25, nullable: false),
                    InstalledRoles = table.Column<string>(maxLength: 50, nullable: false),
                    OperatingSysID = table.Column<int>(nullable: false),
                    MachineTypeID = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MachineWarrantyID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceTag = table.Column<string>(maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueDescription = table.Column<string>(maxLength: 150, nullable: false),
                    IssueDetail = table.Column<string>(nullable: true),
                    TicketOpenedBy = table.Column<string>(maxLength: 50, nullable: false),
                    MachineID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportLogEntry = table.Column<string>(nullable: false),
                    SupportLogUpdatedBy = table.Column<string>(maxLength: 50, nullable: false),
                    SupportTicketID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
